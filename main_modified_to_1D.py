...
"""
# Set the second encoded dimension to 0
pca_transformed[:,1] = 0
encoded_data[:,1] = 0
encoded_data2[:,1] = 0
encoded_data3[:,1] = 0
...
with open('train.pickle', 'wb') as f:
    pickle.dump([pca_transformed, encoded_data, encoded_data2, encoded_data3], f)
"""
# Fit to Gaussian Data
data = pca_transformed[:,:2]
# Fit a normal distribution to the data:
mu, std = norm.fit(data)
# Plot the histogram.
plt.hist(data, bins=25, density=True, alpha=0.6, color='g')
